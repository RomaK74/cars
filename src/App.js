        ...
        <div className="App" id="app">
            <div className="menu-background" id="menuBack">
                <div className="menu-in">
                    <div className="menu-in__item"><a href="#">ПАРКОВКА</a></div>
                    <div className="menu-in__item"><a href="#">СТРАХОВКА</a></div>
                    <div className="menu-in__item"><a href="#">БЕНЗИН</a></div>
                    <div className="menu-in__item"><a href="#">ОБСЛУЖИВАНИЕ</a></div>
                    <div className="social-networks">
                        <div className="social-networks__item"><a href="#">
            ...
            <div className="container">
                ...
                <div className="main-part">
                    <div className="main-part-up">
                        <BurgerMenu className="main-part--bm" toggleBM={toggleBM}/>
                        <div className="main-part-up__TL">
                            <div className="main-part-up__title"><a href="/">Need for drive</a></div>
                            <div className="main-part-up__location"><img src={location} alt=""/> Ульяновск</div>
                        </div>
                    </div>
